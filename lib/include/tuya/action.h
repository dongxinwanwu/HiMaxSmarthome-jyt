...
__ACTION_EXT \
OPERATE_RET actions_check_gw_id(IN CONST ty_cJSON *root);

VOID actions_set_gw_id_check_func(IN ACTION_CHECK_GW_ID_FUNC check_func);

typedef OPERATE_RET (*ACT_CHECK_TYPE_FUNC)(IN CONST CHAR_T* gw_id, IN CONST CHAR_T* act_type);
VOID actions_set_check_type_func(IN ACT_CHECK_TYPE_FUNC check_func);
OPERATE_RET actions_check_type(IN CONST ty_cJSON *root);
