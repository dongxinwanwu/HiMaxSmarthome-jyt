...
typedef enum
{
    ...
    TUYATEST_GENERAL_BOOL_TEST = 0x47,
    TUYATEST_MAX
} TUYATEST_CMD;
...
typedef struct {    
    ...
    TYTEST_COMMON_HANDL general_bool_test_cb;         //71.general bool test callback
}TUYA_TEST_CBS_S;
...
int tuya_prodtest_rep_key_event_repeat(int index, unsigned int key_index);
